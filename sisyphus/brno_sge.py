...
#         Karel Benes <ibenes@fit.vutbr.cz>
    ...
    def submit_call(self, call, logpath, rqmt, name, task_name, task_ids):
        ...
        for task_id in task_ids:
            if start_id is None:
                ...
                job_id = self.submit_helper(call_prefix+call, logpath, rqmt, name, task_name, start_id, end_id, step_size)
